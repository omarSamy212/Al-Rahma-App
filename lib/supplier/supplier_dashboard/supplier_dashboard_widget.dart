...
class _SupplierDashboardWidgetState extends State<SupplierDashboardWidget>
  ...
  late SupplierDashboardModel _model;
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'rok9baet' /* Below are some of the outstand... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
