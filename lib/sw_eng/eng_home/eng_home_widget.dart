...
import 'eng_home_model.dart';
export 'eng_home_model.dart';

class EngHomeWidget extends StatefulWidget {
  const EngHomeWidget({super.key});

  @override
  State<EngHomeWidget> createState() => _EngHomeWidgetState();
}

class _EngHomeWidgetState extends State<EngHomeWidget>
    with TickerProviderStateMixin {
  late EngHomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EngHomeModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Eng_Home'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ENG_HOME_PAGE_Eng_Home_ON_INIT_STATE');
    });
              ...
              child: AppBar(
                ...
                leading: Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('ENG_HOME_PAGE_menu_ON_TAP');
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('ENG_HOME_PAGE_chat_ON_TAP');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'ENG_HOME_PAGE_imageBorder_ON_TAP');
                                                            logFirebaseEvent(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_2r3hv9k4_ON_TAP');
                                                          logFirebaseEvent(
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_jd2t7817_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_9sxt7aen_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_32vxq28v_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_salrv68y_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_cu9ueclj_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_866ita1v_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ENG_HOME_PAGE_Container_hv4rtstp_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_navigate_to');
                                    ...
                                    Align(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'u0c8ksi8' /* Powerd by Omar-s Team */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
