...
class _ComplaintsWidgetState extends State<ComplaintsWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'complaints'});
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('COMPLAINTS_arrow_back_rounded_ICN_ON_TAP');
                              ...
                              Padding(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  options: [
                                    ...
                                    FFLocalizations.of(context).getText(
                                      'chbosett' /* Negligence in work */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      '4psx3ssp' /* Negligence in the covenant */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'j6gidr3p' /* Inslut and slander */,
                                    ),
                                    FFLocalizations.of(context).getText(
                                      'z271u6c3' /* Assault on a co-worker */,
                                    )
                                  ],
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: _model
                                          ...
                                          .asValidator(context),
                                      inputFormatters: [_model.natIDDateMask],
                                    ),
                                  ),
                                ),
                              ),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'COMPLAINTS_PAGE_DAILY_REPORT_BTN_ON_TAP');
                                              logFirebaseEvent(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'zi57x5g5' /* The daily report is delivered ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
