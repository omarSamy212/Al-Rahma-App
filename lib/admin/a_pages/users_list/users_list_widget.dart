              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'USERS_LIST_arrow_back_rounded_ICN_ON_TAP');
                  ...
                  actions: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('USERS_LIST_PAGE_add_User_ON_TAP');
                          logFirebaseEvent('add_User_navigate_to');
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'USERS_LIST_PAGE_RichText_94n066jv_ON_TAP');
                                            await Future.wait([
                                              Future(() async {
                                                logFirebaseEvent(
                                                    'RichText_set_form_field');
                                                setState(() {
                                                  _model.shiftValueController
                                                      ?.value = '';
                                                });
                                              }),
                                              Future(() async {
