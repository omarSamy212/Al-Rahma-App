                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '8tnvoifp' /* Select Starting Shift */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                  ...
                                                  child: FlutterFlowDropDown<
                                                    ...
                                                    hintText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'tq47fjpu' /* Select starting shift  */,
                                                    ),
                                                    icon: Icon(
                                                      Icons
                                                          .keyboard_arrow_down_rounded,
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '5hsor24h' /* Type of driving license? */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                              ...
                              onPressed: () async {
                                ...
                                await widget.user!.update(createUsersRecordData(
                                  ...
                                  backNatImageUrl: () {
                                    ...
                                    } else if (updateUserUsersRecord.backNatImageUrl !=
                                            '') {
                                      return updateUserUsersRecord
                                          .backNatImageUrl;
                                    } else {
