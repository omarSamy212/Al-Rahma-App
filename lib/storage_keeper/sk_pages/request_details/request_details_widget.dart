  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final requestDetailsUsersRecord = snapshot.data!;
        return Title(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Image.network(
                              requestDetailsUsersRecord.photoUrl,
                              fit: BoxFit.cover,
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'ID: #${requestDetailsUsersRecord.userCode}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Plus Jakarta Sans',
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 8.0, 0.0, 12.0),
                                                child: Text(
                                                  '${requestDetailsUsersRecord.shift.startShift}\' \'${requestDetailsUsersRecord.shift.shiftPeriod}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
                                              ...
                                              child: SizedBox(
                                                height:
                                                    MediaQuery.sizeOf(context)
                                                            .height *
                                                        0.5,
                                                child: EndRequestWidget(
                                                  requestDoc: _model.request!,
                                                  supervisorDoc:
                                                      requestDetailsUsersRecord,
                                                ),
                                              ),
