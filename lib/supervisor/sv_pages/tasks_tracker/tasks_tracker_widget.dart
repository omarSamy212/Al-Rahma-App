                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'v5j8e0uc' /* No-Code Platform Design */,
                                  ),
                                                  ...
                                                  child: CheckboxListTile(
                                                    ...
                                                    title: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '9fvbm9hy' /* Design Template Screens */,
                                                      ),
                                              ...
                                              Theme(
                                                ...
                                                child: CheckboxListTile(
                                                  ...
                                                  subtitle: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'kp355nf7' /* Create themes for use by our u... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium
                                                      ...
                                                      child: CheckboxListTile(
                                                        ...
                                                        title: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'rhewwzy4' /* Design Template Screens */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .headlineSmall
                                                        ...
                                                        subtitle: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '6fda2r6b' /* Create template screen for tas... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
                                                    ...
                                                    child: CheckboxListTile(
                                                      ...
                                                      subtitle: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'ivybmynv' /* Create themes for use by our u... */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .labelMedium
                                                      ...
                                                      child: CheckboxListTile(
                                                        ...
                                                        title: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'gxr3fm5t' /* Design Template Screens */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .headlineSmall
                                                        ...
                                                        subtitle: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'ybzktkp4' /* Create template screen for tas... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .labelMedium
                                                    ...
                                                    child: CheckboxListTile(
                                                      ...
                                                      subtitle: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'r5kw0i6m' /* Create themes for use by our u... */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .labelMedium
