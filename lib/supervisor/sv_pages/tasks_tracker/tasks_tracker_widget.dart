                              ...
                              Align(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'wjz3jdpt' /* {Working Area discription} */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'TASKS_TRACKER_PAGE_TaskCard_ON_TAP');
                                            logFirebaseEvent(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'TASKS_TRACKER_DAILY_REPORT_BTN_ON_TAP');
                                              logFirebaseEvent(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            's9e9ngqz' /* The daily report is delivered ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'TASKS_TRACKER_Column_93nl9bqg_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Column_navigate_to');
