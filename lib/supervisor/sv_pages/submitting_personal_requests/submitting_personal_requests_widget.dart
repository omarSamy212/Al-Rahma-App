...
import 'submitting_personal_requests_model.dart';
export 'submitting_personal_requests_model.dart';

class SubmittingPersonalRequestsWidget extends StatefulWidget {
  const SubmittingPersonalRequestsWidget({
    super.key,
  ...
  @override
  State<SubmittingPersonalRequestsWidget> createState() =>
      _SubmittingPersonalRequestsWidgetState();
}

class _SubmittingPersonalRequestsWidgetState
    extends State<SubmittingPersonalRequestsWidget>
    with TickerProviderStateMixin {
  late SubmittingPersonalRequestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmittingPersonalRequestsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Submitting_personal_requests'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('SUBMITTING_PERSONAL_REQUESTS_Submitting_');
      logFirebaseEvent('Submitting_personal_requests_update_page');
      setState(() {
        _model.requestTools =
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'Submitting_personal_requests',
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('SUBMITTING_PERSONAL_REQUESTS_arrow_back_');
            ...
            title: Text(
              FFLocalizations.of(context).getText(
                's68mwluq' /* Submitting personal requests */,
              ),
                  ...
                  children: [
                            ...
                            children: [
                              FlutterFlowDropDown<String>(
                                ...
                                onChanged: (val) async {
                                  ...
                                  logFirebaseEvent(
                                      'SUBMITTING_PERSONAL_REQUESTS_ToolsMenu_O');
                                  logFirebaseEvent(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'p4uuen8w' /* select personal request */,
                                ),
                                icon: Icon(
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'SUBMITTING_PERSONAL_REQUESTS_UploadPhoto');
                        },
                        child: Container(
                          width: double.infinity,
                          constraints: BoxConstraints(
                              ...
                              children: List.generate(uploadedImages.length,
                                ...
                                return Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SUBMITTING_PERSONAL_REQUESTS_imageBorder');
                                    },
                                    child: Container(
                                      width: 100.0,
                                      height: 100.0,
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'SUBMITTING_PERSONAL_REQUESTS_MAKE_REQUES');
