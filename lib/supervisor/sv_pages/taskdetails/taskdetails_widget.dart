          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('TASKDETAILS_arrow_back_rounded_ICN_ON_TA');
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '4mx9l0rp' /* {A beach is a narrow, gently s... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'TASKDETAILS_PAGE_UploadPhoto_ON_TAP');
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    constraints: BoxConstraints(
