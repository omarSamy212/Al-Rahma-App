...
class SubmittingComplaintsWidget extends StatefulWidget {
  const SubmittingComplaintsWidget({super.key});
...
class _SubmittingComplaintsWidgetState extends State<SubmittingComplaintsWidget>
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('SUBMITTING_COMPLAINTS_arrow_back_rounded');
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'SUBMITTING_COMPLAINTS_UploadPhoto_ON_TAP');
                            },
                            child: Container(
                              width: double.infinity,
