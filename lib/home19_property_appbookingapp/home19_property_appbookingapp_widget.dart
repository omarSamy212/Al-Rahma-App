...
class _Home19PropertyAppbookingappWidgetState
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Home19PropertyAppbookingapp'});
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'Home19PropertyAppbookingapp',
