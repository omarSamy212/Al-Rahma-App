                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'wv2eogcc' /* Pay attention to our new athle... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'jj9nmoih' /* Puuuurfect Running Gear */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .headlineMedium
                                      .override(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'n7804qxf' /* Pay attention to our new athle... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'qou3byn2' /* The right pair of shoes */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .headlineMedium
                                      .override(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ae11rfsq' /* The pursuit of speed continues... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'v39qltgo' /* Sign up below in order to get ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleSmall
                                          .override(
