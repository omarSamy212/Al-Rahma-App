...
class _Home07InvoicesWidgetState extends State<Home07InvoicesWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Home07Invoices'});
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('HOME07_INVOICES_arrow_back_rounded_ICN_O');
