...
class _Details03TransactionsSummaryWidgetState
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'Details03TransactionsSummary',
