                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'c2adapdg' /* Join us & work with confidence */,
                                    ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ltn6oh38' /* We are excited to welcome you ... */,
                                    ),
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                ...
                                Theme(
                                  ...
                                  child: CheckboxListTile(
                                    ...
                                    title: Text(
                                      FFLocalizations.of(context).getText(
                                        'xe4dsejp' /* I would like to receive inspri... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
