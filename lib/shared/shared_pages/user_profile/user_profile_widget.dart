                  ...
                  actions: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent('USER_PROFILE_PAGE_edit_ON_TAP');
                      ...
                      children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'ID: #${userProfileUsersRecord.userCode}',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Plus Jakarta Sans',
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'USER_PROFILE_PAGE_Row_ovnvzoxt_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Row_call_number');
                                                    await launchUrl(Uri(
                                                      scheme: 'tel',
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 8.0, 0.0, 12.0),
                                              child: Text(
                                                '${userProfileUsersRecord.shift.startingShift}\' \'${userProfileUsersRecord.shift.shiftPeriod}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                          ...
                                          Align(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '87n7gxv1' /* Expected Finsh time:  16:30 */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'USER_PROFILE_RichText_tabld9u4_ON_TAP');
                              },
                              child: RichText(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: BarcodeWidget(
                              data: userProfileUsersRecord.reference.id,
