...
import 'add_servicingreport_model.dart';
export 'add_servicingreport_model.dart';

class AddServicingreportWidget extends StatefulWidget {
  const AddServicingreportWidget({super.key});

  @override
  State<AddServicingreportWidget> createState() =>
      _AddServicingreportWidgetState();
}

class _AddServicingreportWidgetState extends State<AddServicingreportWidget> {
  late AddServicingreportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddServicingreportModel());
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('ADD_SERVICINGREPORT_arrow_back_rounded_I');
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'ADD_SERVICINGREPORT_done_button_ON_TAP');
                              },
