  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> addServicingreportUsersRecordList = snapshot.data!;
        return Title(
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'ADD_SERVICINGREPORT_arrow_back_rounded_I');
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .theDriverValueController ??=
                                              FormFieldController<String>(
                                            _model.theDriverValue ??= '',
                                          ),
                                          options: List<String>.from(
                                              addServicingreportUsersRecordList
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    logFirebaseEvent(
                                        'done_button_custom_action');
                                    _model.serviceRequest =
                                        await actions.createServiceRequest(
                                      ...
                                      _model.theTruckValue == 'تروسيكل'
                                          ...
                                          : '',
                                      int.parse(
                                          _model.totalPriceTextController.text),
                                    );
                                    if (_model.serviceRequest!) {
                                      logFirebaseEvent(
