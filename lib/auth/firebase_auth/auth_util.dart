...
DocumentReference? get currentUserReference =>
    loggedIn ? AuthUserRecord.collection.doc(currentUser!.uid) : null;

AuthUserRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AuthUserRecord.getDocument(AuthUserRecord.collection.doc(uid))
              .handleError((_) {}),
    )
