            ...
            appBar: AppBar(
              ...
              title: Column(
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'mnz2jhha' /* Please fill out the form below... */,
                    ),
              ...
              actions: [
                Padding(
                  ...
                  child: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'CREATE04_TASK_close_rounded_ICN_ON_TAP');
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowChoiceChips(
                                        options: [
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'oi935hqc' /* Product Design */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'ur0862y5' /* FlutterFlow */,
                                          )),
                                          ChipData(FFLocalizations.of(context)
                                              .getText(
                                            'i32cf96v' /* UI Design */,
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'CREATE04_TASK_Container_0s4z5iq0_ON_TAP');
                                          logFirebaseEvent(
